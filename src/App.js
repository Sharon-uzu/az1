      ...
      <AppContextProvider>
        ...
        <Routes>
          ...
          <Route path="/Vendor" element={<Vendor />} />
           ...
           <Route path="RidersHome" element={<RidersHome/>}/>

            <Route path="RidersC" element={<RidersC/>}/>

            <Route path="PickUp" element={<PickUp/>}/>

             <Route path="TrackOrder" element={<TrackOrder/>}/>

             <Route path="CallRinging" element={<CallRinging/>}/>
             ...
             <Route path="AdminCallRinging" element={<AdminCallRinging/>}/>

             <Route path="AdminCall" element={<AdminCall/>}/>

             <Route path="VendorCallRinging" element={<VendorCallRinging/>}/>

             <Route path="VendorCall" element={<VendorCall/>}/>
